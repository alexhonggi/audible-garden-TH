...
#define ARROW_CXX_COMPILER_FLAGS " -fno-aligned-new -ftree-vectorize -fPIC -fPIE -fstack-protector-strong -O2 -pipe -stdlib=libc++ -fvisibility-inlines-hidden -fmessage-length=0 -isystem /opt/anaconda3/include -fdebug-prefix-map=/var/folders/nz/j6p8yfhx1mv_0grj5xl4650h0000gp/T/abs_04tl_mz7cj/croot/arrow-cpp_1738050289828/work=/usr/local/src/conda/arrow-cpp-19.0.0 -fdebug-prefix-map=/opt/anaconda3=/usr/local/src/conda-prefix -Qunused-arguments -fcolor-diagnostics  -Wall -Wno-unknown-warning-option -Wno-pass-failed "
